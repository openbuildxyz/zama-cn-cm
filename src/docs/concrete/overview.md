...
**Concrete** 是 Zama 开发的开源 FHE 编译器，能将 Python 程序自动编译为等价的 FHE 电路，让开发者无需了解密码学细节即可实现同态计算。

> 官方文档：[docs.zama.org/concrete](https://docs.zama.org/concrete) | GitHub：[zama-ai/concrete](https://github.com/zama-ai/concrete)
...
```
Python 函数 → Concrete 编译器 → FHE 电路 → 在加密数据上执行
```
...
- [官方文档](https://docs.zama.org/concrete)
- [GitHub 仓库](https://github.com/zama-ai/concrete)
- [示例集合](https://github.com/zama-ai/concrete/tree/main/docs/core-features)
